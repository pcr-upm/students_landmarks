...
class HourGlass(nn.Module):
    def __init__(self, num_modules, depth, num_features, first_one=False):
        ...
        self.coordconv = CoordConvTh(x_dim=128, y_dim=128,
...
def create_StackedHG(num_modules, num_landmarks):
    net = FAN(num_modules=num_modules, num_landmarks=num_landmarks)
    return net
