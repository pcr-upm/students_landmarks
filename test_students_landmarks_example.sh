...
sudo docker exec -w /home/username/ students_landmarks_container python images_framework/alignment/students_landmarks/test/students_landmarks_test.py --input-data images_framework/alignment/students_landmarks/test/example.tif --database wflw --gpu 0 --backbone shg --save-image
